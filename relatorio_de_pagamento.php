...
<body>
<form action="pagina_relatorio_pagamentos.php" method="post" target="_blank">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table">
  	<tbody>
    	<tr>
      		<td height="42" colspan="4" align="center" valign="top">
      		<span class="titulo">Relatório de Pagamento de Pedidos</span>
      		</td>
    	</tr>
     <tr>
    		<td height="42" width="48%" align="center" style="padding-right: 20px;">
      		Por Loja:  
      		<select name="loja" class="select" style="width: 64%;">
