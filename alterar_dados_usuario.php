...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $id_user = test_input($_POST["id_usuario"]);
  ...
  $altera = DBUpDate('usuario', $pedido, 'id_usuario="'.$id_user.'"');
...
//LÊ DADOS DO BANCO
  $le_user = DBRead ('usuario', "WHERE id_usuario = '$id'", "id_usuario, nome_usuario, cpf_usuario, end_usuario, fixo_usuario, cel_usuario, email_usuario, tipo_usuario, login_usuario");
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
  <tbody>
    <tr>
      <td height="42" colspan="2" align="center" valign="top"><span class="titulo">Alterar meu dados</span></td>
    </tr>
    <tr>
      <td width="16%" align="right">Nome: <input type="hidden" name="id_usuario" value="<?php echo $user['id_usuario']; ?>"></td>
      <td width="84%"><input type="text" name="nome" class="text" value="<?php echo $user['nome_usuario']; ?>"></td>
    </tr>
    <tr>
      <td align="right">CPF:</td>
      <td><input type="text" name="cpf" class="cod" maxlength="14" readonly value="<?php echo $user['cpf_usuario']; ?>"></td>
    </tr>
    <tr>
      <td align="right">Endereço:</td>
      <td><input type="text" name="endereco" class="text" value="<?php echo $user['end_usuario']; ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="email" class="text" value="<?php echo $user['email_usuario']; ?>"></td>
    </tr>
    <tr>
      <td align="right">Seu Login:</td>
      <td><input type="text" name="login" class="text" readonly value="<?php echo $user['login_usuario']; ?>"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
